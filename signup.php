...
<body class="flex items-center justify-center min-h-screen bg-gray-100">
    <div class="w-full max-w-sm">
        <h3 class="text-center m-4 font-bold">Sign Up</h3>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        echo "<div class='text-green-500 text-center mt-4'>Signup successful for " . htmlspecialchars($username) . " (" . htmlspecialchars($email) . ").</div>";
    }
    ?>
</body>
